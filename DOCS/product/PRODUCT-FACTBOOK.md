...
Generated 2026-09-23 from commit `ee80c34`.

- TypeScript files: **553** · lines: **1,01,437**
- Database tables: **133**
- API route files: **242** · operations (GET/POST/PUT/PATCH/DELETE): **340**
- End-to-end test suites: **30**
