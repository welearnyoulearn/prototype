...
Generated 2026-09-21 from commit `f88148c`.

- TypeScript files: **516** · lines: **96,539**
- Database tables: **130**
- API route files: **234** · operations (GET/POST/PUT/PATCH/DELETE): **333**
- End-to-end test suites: **24**
