...
Generated 2026-09-21 from commit `2b3895a`.

- TypeScript files: **535** · lines: **98,411**
- Database tables: **133**
- API route files: **238** · operations (GET/POST/PUT/PATCH/DELETE): **336**
- End-to-end test suites: **28**
