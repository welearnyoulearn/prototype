...
<!-- AUTO:evidence:feedback-management:start (generated by scripts/product-docs.mjs — do not edit by hand) -->
**Code evidence** — checked against the repository on every run of `node scripts/product-docs.mjs`.

Screens: `app/school-admin/components/FeedbackManagement.tsx`, `app/school-admin/components/feedback/FeedbackCategoryEditor.tsx`, `app/school-admin/components/feedback/FeedbackDashboardTab.tsx`, `app/school-admin/components/feedback/FeedbackIssueTable.tsx`, `app/school-admin/components/feedback/FeedbackQrPoster.tsx`, `app/school-admin/components/feedback/FeedbackSubmissionsTab.tsx`, `app/school-admin/components/feedback/useFeedbackFetch.ts`, `app/feedback/[code]/advancedFormVisuals.ts`, `app/feedback/[code]/FeedbackWizard.tsx`, `app/feedback/[code]/page.tsx`, `app/feedback/[code]/roleVisuals.ts`, `app/feedback/[code]/steps/AdvancedFormStep.tsx` (+11 more)

API routes these screens call (all exist):
- `GET/POST` /api/feedback/categories
- `PATCH` /api/feedback/categories/{}
- `GET` /api/feedback/issues
- `PATCH` /api/feedback/issues/{}
- `GET` /api/feedback/qr
- `GET` /api/feedback/resolve
- `GET/PATCH` /api/feedback/settings
...
<!-- AUTO:evidence:feedback-management:end -->
