...
const roles = [
  {
    ...
    tape: '-rotate-2',
    pin: 'bg-indigo-500',
    accent: 'bg-indigo-500 group-hover:bg-indigo-600',
    ring: 'group-hover:ring-indigo-200',
    caption: 'Front office, 8:15am',
  },
  {
    title: 'Teacher',
    description: 'Mark attendance, enter marks, answer student doubts',
    href: '/teacher/login',
    testid: 'teacher',
  ...
  {
    title: 'Student',
    description: 'View timetable, check marks & doubts',
    href: '/student/login',
    testid: 'student',
    ...
    tape: '-rotate-1',
    pin: 'bg-amber-500',
    accent: 'bg-amber-500 group-hover:bg-amber-600',
  ...
  },
  {
    ...
    tape: 'rotate-2',
    pin: 'bg-rose-500',
    accent: 'bg-rose-500 group-hover:bg-rose-600',
          ...
          <div data-testid="portal-selection" className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {roles.map((role) => (
              <Link
                ...
                className={`group relative flex flex-col bg-white border border-stone-200 rounded-xl overflow-hidden shadow-[3px_4px_0_0_rgba(28,25,23,0.06)] hover:shadow-[5px_6px_0_0_rgba(28,25,23,0.1)] hover:-translate-y-1 ring-1 ring-transparent transition-all duration-300 ${role.ring}`}
              >
                {/* pin */}
                ...
                <div className="p-4 flex-1 flex flex-col">
                  ...
                  <span className={`inline-flex items-center justify-center gap-1.5 text-xs font-semibold text-white mt-4 px-4 py-2 rounded-full w-fit transition-all ${role.accent}`}>
                    Log in
