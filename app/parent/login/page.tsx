    ...
    <AuthShell theme={theme} title="Parent Portal" subtitle="Monitor your child's progress and academic journey">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          ...
          />
          <p className="text-xs text-gray-400 mt-1">Use the email address your school has on record</p>
        </div>
        ...
        <div className="flex justify-end">
          <Link href="/parent/forgot-password" className="text-sm text-teal-600 hover:text-teal-800 font-medium transition">
            Forgot password?
          </Link>
        </div>
      ...
      <div className="mt-5 pt-5 border-t border-gray-100 text-center">
        <p className="text-xs text-gray-400">Account created automatically when your child was enrolled. Check your welcome email for credentials.</p>
