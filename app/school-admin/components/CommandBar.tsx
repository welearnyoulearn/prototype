...
const QUICK_ACTIONS: Result[] = [
  { type: 'action', label: 'Add New Teacher',        sub: 'Open staff onboarding', nav: 'staff-onboarding' },
  { type: 'action', label: 'Add New Student',         sub: 'Open student onboarding', nav: 'student-onboarding' },
  ...
  { type: 'action', label: 'Daily Briefing',          sub: 'Today\'s summary', nav: 'briefing' },
  { type: 'action', label: 'Year Rollover',           sub: 'Promote students to next grade', nav: 'year-rollover' },
]
...
const NAV_SEARCH: Result[] = [
  ...
  { type: 'nav', label: 'Teachers',           sub: 'Staff management',    nav: 'teachers' },
  { type: 'nav', label: 'Students',           sub: 'Student management',  nav: 'students' },
  { type: 'nav', label: 'Timetable',          sub: 'Class schedules',     nav: 'timetable' },
  { type: 'nav', label: 'Exam Schedule',      sub: 'Exams & calendar',    nav: 'exam-schedule' },
  ...
  { type: 'nav', label: 'Class Analytics',    sub: 'Performance view',    nav: 'class-analytics' },
  { type: 'nav', label: 'Academic Analytics', sub: 'Marks & results',     nav: 'academic-analytics' },
  { type: 'nav', label: 'Announcements',      sub: 'Notice board',        nav: 'announcements' },
  { type: 'nav', label: 'Academic Calendar',  sub: 'Events & holidays',   nav: 'calendar' },
  { type: 'nav', label: 'Leaderboard',        sub: 'Top students',        nav: 'leaderboard' },
  { type: 'nav', label: 'Export & Reports',   sub: 'Download data',       nav: 'export' },
  { type: 'nav', label: 'Parent Engagement',  sub: 'Parent overview',     nav: 'parent-engagement' },
  { type: 'nav', label: 'Daily Briefing',     sub: 'Today\'s summary',    nav: 'briefing' },
  ...
  { type: 'nav', label: 'Year Rollover',      sub: 'Promote students',    nav: 'year-rollover' },
]
