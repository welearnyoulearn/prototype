...
const SchoolFeedback        = dynamic(() => import('./components/SchoolFeedback'),          { loading: () => <ModuleSkeleton /> })
...
const NAV_SECTIONS = [
  ...
  { label: 'COMMUNICATION', keys: ['announcements', 'school-feedback'] },
          ...
          <main className="flex-1 overflow-y-auto p-3 sm:p-6">
            {tier === 'none' ? (
              ...
              <FeaturesProvider value={enabledFeatures}>
                ...
                {visited.has('school-feedback')  && <div hidden={activeNav !== 'school-feedback'}><SchoolFeedback schoolId={selectedSchool.id} /></div>}
